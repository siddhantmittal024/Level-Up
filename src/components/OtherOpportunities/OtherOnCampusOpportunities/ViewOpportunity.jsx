...
const ViewOtherOnCampusOpportunity = () => {
  const { id } = useParams();
  //console.log('ID', id);
        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography>Contact: {otherOpportunity.contact}</Typography>
            </Box>
          </Box>
        </Box>
      </Container>
...
export default ViewOtherOnCampusOpportunity;
