...
const CreateOnCampusInternship = () => {
  const auth = getAuth();
  ...
  const onSubmit = async (event) => {
    ...
    if (
      ...
      try {
        ...
        const internshipRef = doc(collection(db, 'on-campus-internships'));
        await setDoc(internshipRef, values);
...
export default CreateOnCampusInternship;
